...
*/
public class GraphicsKDisable extends GraphicsKHandler
{
	public LHHandler handleKeyword() throws LLException
	{
		...
		if (isSymbol())
		{
			...
			{
				return new GraphicsHEnable(line,(GraphicsHButton)handler,false);
			}
			if (handler instanceof GraphicsHLabel)
			{
				return new GraphicsHEnable(line,(GraphicsHLabel)handler,false);
			}
