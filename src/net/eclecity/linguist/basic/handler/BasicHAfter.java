...
*/
public class BasicHAfter extends LHHandler
{
	...
	*/
	public BasicHAfter(int line,LVValue count,int scale,int where,int next)
	{
		super(line);
		this.count=count;
		this.scale=scale;
	...
	{
		program.addTimer(count.getIntegerValue()*scale,where,false);
		return next;
	}
}
