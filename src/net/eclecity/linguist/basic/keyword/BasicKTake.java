...
import net.eclecity.linguist.basic.handler.BasicHTake;
...
*/
public class BasicKTake extends LKHandler
{
	public LHHandler handleKeyword() throws LLException
	{
      ...
      if (isSymbol())
      {
	      ...
	      return new BasicHTake(line,value,(LHValueHolder)variable,(LHValueHolder)target);
	   }
