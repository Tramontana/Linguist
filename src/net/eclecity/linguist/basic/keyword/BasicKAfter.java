...
import net.eclecity.linguist.basic.handler.BasicHAfter;
...
*/
public class BasicKAfter extends LKHandler
{
	public LHHandler handleKeyword() throws LLException
	{
	   ...
	   int where=getPC();
		...
		int next=getPC();
		LHHandler timer=new BasicHAfter(line,count,scale,where,next);
