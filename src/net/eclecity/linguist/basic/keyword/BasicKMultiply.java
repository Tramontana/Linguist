...
import net.eclecity.linguist.basic.handler.BasicHMultiply;
...
*/
public class BasicKMultiply extends LKHandler
{
	public LHHandler handleKeyword() throws LLException
	{
      ...
      if (isSymbol())
      {
	      ...
	      if (variable instanceof LHValueHolder)
	      {
		      ...
		      return new BasicHMultiply(line,value,(LHValueHolder)variable,(LHValueHolder)target);
		   }
		}
