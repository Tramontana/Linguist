...
/******************************************************************************
	Return one value multiplied by another.
	<pre>
	[1.001 GT]  29/11/00  New class.
	</pre>
*/
public class BasicVMultiplied extends LVValue
{
	private LVValue value1;
	private LVValue value2;

	public BasicVMultiplied(LVValue value1,LVValue value2)
	{
		this.value1=value1;
		this.value2=value2;
	}
