...
public class Base64
{
	...
	public static String encodeObject(java.io.Serializable serializableObject)
	{
		...
		try
		{
			...
			b64os = new Base64.Base64OutputStream(baos, Base64.ENCODE);
	...
	public static class Base64OutputStream extends java.io.FilterOutputStream
	{
		 ...
		 * @since 1.3
		 */
		public Base64OutputStream(java.io.OutputStream out, boolean encode)
		{
			super(out);
			this.encode = encode;
			...
			else
			{
				...
				if (DECODABET[theByte & 0x7f] > WHITE_SPACE_ENC)
				{
					...
					if (position >= bufferLength) // Enough to output.
					{
						...
						"Invalid character in Base64 data."); } // end else: not white
				// space either
			} // end else: decoding
		} // end write
